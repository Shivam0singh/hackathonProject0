...
import { FaMoon, FaSun, FaSeedling, FaLeaf, FaTimes } from "react-icons/fa"; // React Icons
...
const CycleTracker = () => {
  ...
  const [selectedZodiac, setSelectedZodiac] = useState("Libra"); // Default zodiac sign
  const [isAstrologyModalOpen, setIsAstrologyModalOpen] = useState(false); // New state for astrology modal
  // Fetch cycle data
  useEffect(() => {
